...
export function meta({ }: Route.MetaArgs) {
  return generatePageMeta({
    title: "EvenEi Pricing — Affordable, Practical AI Systems",
    description:
      "EvenEi pricing reflects value, not complexity. Affordable AI-powered intelligent systems designed for long-term sustainable use.",
    path: "/pricing",
  });
}
