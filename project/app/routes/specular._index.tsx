...
import { generatePageMeta, generateBreadcrumbSchema, generateProductSchema, generateSoftwareApplicationSchema, generateFAQSchema, JsonLd, SEO } from '~/lib/seo';
...
const specularFAQs = [
  {
    ...
    answer:
      "EvenEi Specular (also called SpecEI or Project Specular) is the world's first memory-based smart glasses system. It passively captures visual and audio context, automatically structures it, and allows you to search your own life. Unlike traditional smart glasses, Specular uses a software-first architecture to keep the hardware lightweight and affordable.",
  },
  {
  ...
  {
    question: "What are the key features of EvenEi Specular?",
    answer:
      "Key features include hands-free passive capture, AI-powered visual understanding and context recognition, searchable memory indexing, intelligent filtering, LLM-based transcription, and a companion mobile app for AI processing, storage, and privacy controls.",
  },
  {
    question: "Is EvenEi Specular available for purchase?",
    answer:
      "EvenEi Specular is currently a research and development project. The team is refining hardware prototypes and expanding AI capabilities. Visit the EvenEi website for the latest updates on availability.",
  },
  {
...
export function meta() {
  return generatePageMeta({
    title: "EvenEi Specular — AI-Powered Memory Smart Glasses | Project Specular",
    description:
      "Project Specular by EvenEi is the world's first memory-based AI smart glasses. Passively captures, understands, and recalls your life. Software-first architecture starting at $120.",
    path: "/specular",
  });
}
    ...
    <div className={styles.page}>
      <JsonLd
        data={generateBreadcrumbSchema([
          ...
          { name: "Specular", url: `${SEO.siteUrl}/specular` },
        ])}
      />
      <JsonLd data={generateProductSchema()} />
      <JsonLd data={generateSoftwareApplicationSchema()} />
      <JsonLd data={generateFAQSchema(specularFAQs)} />
      {/* Navigation */}
