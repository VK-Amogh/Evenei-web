...
export function meta({ }: Route.MetaArgs) {
  return generatePageMeta({
    title: "Careers at EvenEi — Build Intelligent Systems That Matter",
    description:
      "Join EvenEi and help build thoughtful, intelligent systems. We look for people who think in systems, care about user experience, and value ethical design.",
    path: "/careers",
  });
}
    ...
    <main className={styles.container}>
      <JsonLd
        data={generateBreadcrumbSchema([
          ...
          { name: "Careers", url: `${SEO.siteUrl}/careers` },
        ])}
      />
      {/* Hero Section */}
