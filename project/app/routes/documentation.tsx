...
export function meta({ }: Route.MetaArgs) {
  return generatePageMeta({
    title: "EvenEi Documentation — System Guides, APIs & Architecture",
    description:
      "EvenEi documentation: clear system guides, developer-friendly APIs, and architectural insights for building with Everyday Intelligence.",
    path: "/documentation",
  });
}
    ...
    <main className={styles.container}>
      <JsonLd
        data={generateBreadcrumbSchema([
          ...
          { name: "Documentation", url: `${SEO.siteUrl}/documentation` },
        ])}
      />
      {/* Hero Section */}
