...
export function meta({ }: Route.MetaArgs) {
  return generatePageMeta({
    title: "EvenEi Features — Intelligent System Capabilities",
    description:
      "Explore EvenEi's system capabilities: context awareness, seamless integration, privacy-first design, and AI that improves continuously through software.",
    path: "/features",
  });
}
    ...
    <main className={styles.container}>
      <JsonLd
        data={generateBreadcrumbSchema([
          ...
          { name: "Features", url: `${SEO.siteUrl}/features` },
        ])}
      />
      {/* Hero Section */}
