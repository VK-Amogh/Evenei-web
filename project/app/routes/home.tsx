...
import { generatePageMeta, generateFAQSchema, JsonLd, SEO } from "~/lib/seo";
import {
  ArrowRight,
  Brain,
  Cpu,
...
const homeFAQs = [
  {
    ...
    answer:
      "EvenEi (also known as EvenEi Private Limited) is a technology company focused on designing intelligent systems that integrate naturally into everyday life. EvenEi builds Everyday Intelligence (EI) — AI systems embedded into workflows, environments, and experiences rather than existing as isolated tools.",
  },
  {
    question: "Who founded EvenEi?",
    answer:
      "EvenEi was founded by Amogh V K, an engineer and system thinker focused on building intelligent systems that combine hardware, software, and AI with real-world usability and ethical design.",
  },
  {
...
export function meta({ }: Route.MetaArgs) {
  return generatePageMeta({
    title: "EvenEi — Building Everyday Intelligence | AI Systems Company",
    description:
      "EvenEi is a technology company building Everyday Intelligence — AI systems that integrate naturally into daily life. Explore our vision, products like Specular smart glasses, and human-centered AI approach.",
    path: "/",
  });
}
