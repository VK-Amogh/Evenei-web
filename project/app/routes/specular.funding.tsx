...
export function meta() {
    return generatePageMeta({
        title: "Why SpecEI Deserves Funding — EvenEi Specular Investment Case",
        description:
            "Detailed breakdown of why SpecEI's software-first architecture, realistic use cases, and ethical design make it a fundable and scalable intelligent wearable platform.",
        path: "/specular/funding",
    });
}
        ...
        <div className={styles.page}>
            <JsonLd
                data={generateBreadcrumbSchema([
                    ...
                    { name: "Funding", url: `${SEO.siteUrl}/specular/funding` },
                ])}
            />
