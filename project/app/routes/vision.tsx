...
export function meta({ }: Route.MetaArgs) {
  return generatePageMeta({
    title: "EvenEi Vision — Making Intelligence Part of Everyday Life",
    description:
      "EvenEi's vision is to make intelligence a quiet but powerful part of everyday life. We design AI systems that adapt to people, not the other way around.",
    path: "/vision",
  });
}
    ...
    <main className={styles.container}>
      <JsonLd
        data={generateBreadcrumbSchema([
          ...
          { name: "Vision", url: `${SEO.siteUrl}/vision` },
        ])}
      />
      {/* Hero Section */}
