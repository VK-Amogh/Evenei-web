...
import { generatePageMeta, generateBreadcrumbSchema, generateFAQSchema, JsonLd, SEO } from "~/lib/seo";
...
const aboutFAQs = [
  {
    ...
    answer:
      "EvenEi is a technology company built around one core idea: Everyday Intelligence. EvenEi designs intelligent systems that integrate naturally into daily life — not isolated AI tools, but systems embedded into workflows and experiences that adapt to people.",
  },
  {
    question: "What does EvenEi do?",
    answer:
      "EvenEi builds AI-powered systems for everyday use focusing on human-centered design, privacy-first architecture, and real-world deployment. Their flagship project is Specular — the world's first memory-based smart glasses.",
  },
  {
    question: "What is EvenEi's philosophy?",
    answer:
      "EvenEi is a systems company first, not a feature-driven startup. They prioritize strong architectural foundations and ethical, privacy-first intelligence with emphasis on usability, ethics, and long-term scalability.",
  },
];

export function meta({ }: Route.MetaArgs) {
  return generatePageMeta({
    title: "About EvenEi — Everyday Intelligence Technology Company",
    description:
      "EvenEi is a technology company built around Everyday Intelligence. Learn about our mission to design intelligent, privacy-first AI systems that integrate naturally into daily life.",
    path: "/about",
  });
}
