...
export function meta({ }: Route.MetaArgs) {
  return generatePageMeta({
    title: "EvenEi Roadmap — System-First Development Path",
    description:
      "EvenEi's development roadmap prioritizes stability, clarity, and scalability over rapid feature growth. See what we're building next.",
    path: "/roadmap",
  });
}
    ...
    <main className={styles.container}>
      <JsonLd
        data={generateBreadcrumbSchema([
          ...
          { name: "Roadmap", url: `${SEO.siteUrl}/roadmap` },
        ])}
      />
      {/* Hero Section */}
