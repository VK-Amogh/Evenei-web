...
export function meta({ }: Route.MetaArgs) {
  return generatePageMeta({
    title: "EvenEi Blog — Insights on Everyday Intelligence & AI Systems",
    description:
      "The EvenEi blog explores ideas behind Everyday Intelligence: system design, applied AI, human-centered technology, ethics, and privacy.",
    path: "/blog",
  });
}
