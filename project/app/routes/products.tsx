...
import { generatePageMeta, generateBreadcrumbSchema, generateProductSchema, JsonLd, SEO } from "~/lib/seo";
...
export function meta({ }: Route.MetaArgs) {
    return generatePageMeta({
        title: "EvenEi Products — Specular AI Smart Glasses & Intelligent Systems",
        description:
            "Explore the products built by EvenEi Private Limited, including Project Specular — the world's first memory-based AI smart glasses system for everyday use.",
        path: "/products",
    });
}
        ...
        <main className={styles.container}>
            <JsonLd
                data={generateBreadcrumbSchema([
                    ...
                    { name: "Products", url: `${SEO.siteUrl}/products` },
                ])}
            />
